...
from qa_test.helpers.log_helper import log_operation, log_error
...
def drop_namespace(database, namespace_name):
    ...
    Drop a namespace
    """
    # log_operation.info(f"Drop a namespace ")
    db, db_name = database
...
def get_namespace_list(database):
    ...
    """
    log_operation.info(f"Get list of namespaces in database")
    db, db_name = database
...
def get_ns_description(database, namespace):
    ...
    """
    log_operation.info(f"Get information about namespace in database")
